...
try:
    ...
    plt.plot(theoretical_test_sizes, np.log2(theoretical_test_sizes) / 1e6, label='Theoretical O(log n)', linestyle='--')
    plt.plot(theoretical_test_sizes, theoretical_test_sizes / 1e6, label='Theoretical O(n)', linestyle='--')
